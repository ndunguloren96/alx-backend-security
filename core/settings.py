...
SECRET_KEY = 'django-insecure-2h)ld4=#ek(%!!7v5mz7bq!*f8ni26)@-h^t=x=js5+l_p*5u('
...
# Optional: Add a setting for the cache limit if you want to make it configurable
REQUEST_LOG_CACHE_LIMIT = 100 # Example value
